          ...
          for(int f = 0; f < img[0].length -1 ; f++) {
              ...
              for (int c  = 0; c < img[1].length - 1; c++) {
                  ...
                  if(img[f][c]==BLACK && img[f][c] >= 0){
                      ...
                      int size = api.findCardinalitat(img[f][c]) * -1; // Creo que el merge está fastidiado por esto todos deberían colgar del primero no?
